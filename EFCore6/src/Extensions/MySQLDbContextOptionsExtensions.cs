...
{
  /// <summary>
  ///   MySQL Server specific extension methods for <see cref="DbContextOptionsBuilder" />.
  /// </summary>
  public static class MySQLDbContextOptionsExtensions
  {
    /// <summary>
    ///   <para>
    ///   Configures the context to use to connect to a MySQL Server database, but without initially setting any
    ...
    /// <param name="mySqlOptionsAction">An optional action to enable an additional MySQL server-specific configuration.</param>
    ...
    /// <summary>
    ///   Configures  the context to use to connect to a MySQL Server database.
    /// </summary>
    /// <param name="optionsBuilder">The builder being used to configure the context.</param>

...
namespace MySql.EntityFrameworkCore.Migrations
{
  ...
  internal class MySQLMigrationsSqlGenerator : MigrationsSqlGenerator
  {
    ...
    protected virtual void Generate([NotNull] MySQLDropDatabaseOperation operation, [CanBeNull] IModel model,
      ...
      bool terminate = true)
    {
      ...
      tableOptions.AddRange(MySQLEntityTypeExtensions.DeserializeTableOptions(operation[MySQLAnnotationNames.StoreOptions] as string)

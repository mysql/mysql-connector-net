...
namespace MySqlX.Data.Tests
{
  public class ClientSideFailoverTests : BaseTest
  {
    ...
    public void SequentialMethodWithBasicFormatConnectionString()
    {
      ...
      Assert.Equal("Providing a port number as part of the host address isn't supported when using connection strings in basic format. Use URI format instead.", ex.Message);
    }

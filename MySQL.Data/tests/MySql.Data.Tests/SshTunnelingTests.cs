...
namespace MySql.Data.MySqlClient.Tests
{
  public class SshTunnelingTests
  {
    ...
    public void ErrorsRaisedByMissingParameters()
    {
      ...
      builder.SshKeyFile = KEY_FILE_PATH;
      ...
      builder.SshPassphrase = KEY_FILE_PASSPHRASE;
      ValidateConnection(builder.ConnectionString);
    }
    ...
    {
      var builder = new MySqlConnectionStringBuilder();
      builder.UserID = "remote";
      builder.Password = "test";
      builder.Server = REMOTE_HOST_NAME;
      builder.Port = MYSQL_SERVER_PORT;
      builder.SshAuthenticationMode = SshAuthenticationMode.Password;
      builder.SshHostName = SSH_HOST_NAME;
      builder.SshUserName = SSH_USER_NAME;
    ...
    /// <summary>
    /// Validates that Connector/NET withouth SSH tunneling is not able to connect to a MySQL Server
    ...
    {
      var keyFile = new PrivateKeyFile(KEY_FILE_PATH, KEY_FILE_PASSPHRASE);

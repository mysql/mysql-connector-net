...
namespace MySql.Data.MySqlClient.Tests
{
  public class StressTests : TestBase
  {
    ...
    public async Task CommandAsyncStress()
    {
      ...
      {
        using (var dbConn = new MySqlConnection($"server={Host};user={Settings.UserID};database={Settings.Database};port={Port};password={Settings.Password};sslmode=disabled"))

...
namespace MySql.Data.MySqlClient.Replication
{
  ...
  public abstract class ReplicationServerGroup
  {
    ...
    /// <summary>
    /// The retry time between connections to failed servers.
    /// </summary>
    public int RetryTime { get; protected set; }
    /// <summary>
    /// The server list in the group.
    /// </summary>
    ...
    /// <param name="isMaster"><c>true</c> if the server to add is master; otherwise <c>false</c> for slave server.</param>
    ...
    /// </summary>
    /// <param name="name">The server name</param>
    /// <returns>A replication server.</returns>
    ...
    /// <c>null</c> if no available server is found.
    /// </returns>
    ...
    /// <returns>The next server based on the load balancing implementation. Null if no available server is found.</returns>
    ...
    /// This method can be overriden to implement a custom failover handling
    /// </summary>

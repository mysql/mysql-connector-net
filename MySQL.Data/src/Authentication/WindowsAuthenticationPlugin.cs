...
namespace MySql.Data.MySqlClient.Authentication
{
  ...
  public struct SecPkgContext_Sizes
  {
    ...
    /// <summary>
    /// Specifies the maximum size of the signature created by the <c>MakeSignature</c> function. This member must be zero if integrity services are not requested or available.
    /// </summary>

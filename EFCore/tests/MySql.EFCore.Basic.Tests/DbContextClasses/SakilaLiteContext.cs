...
namespace MySql.EntityFrameworkCore.Basic.Tests.DbContextClasses
{
  ...
  public partial class SakilaLiteContext : MyTestContext
  {
    ...
    {
      // Actor data
      this.Database.ExecuteSqlRaw(SakilaLiteData.ActorData);
      // Film data
      this.Database.ExecuteSqlRaw(SakilaLiteData.FilmData);
      // FilmActor data
      this.Database.ExecuteSqlRaw(SakilaLiteData.FilmActorData);
      // Address data
      this.Database.ExecuteSqlRaw(SakilaLiteData.AddressData);
      // Customer data
      this.Database.ExecuteSqlRaw(SakilaLiteData.CustomerData);
    }
    ...
    protected virtual void SetFilmEntity(ModelBuilder modelBuilder)
    {
      modelBuilder.Entity<Film>(entity =>
      {
        ...
        entity.HasIndex(e => e.LanguageId)
            .HasDatabaseName("idx_fk_language_id");

        entity.HasIndex(e => e.OriginalLanguageId)
            .HasDatabaseName("idx_fk_original_language_id");
    ...
    protected virtual void SetCustomerEntity(ModelBuilder modelBuilder)
    {
      modelBuilder.Entity<Customer>(entity =>
      {
        ...
        entity.HasIndex(e => e.StoreId)
            .HasDatabaseName("idx_fk_store_id");
    ...
    protected virtual void SetAddressEntity(EntityTypeBuilder<SakilaAddress> entity)
    {
      ...
      entity.HasIndex(e => e.CityId)
          .HasDatabaseName("idx_fk_city_id");
  ...
  public class SakilaLiteOwnedTypesContext : SakilaLiteContext
  {
    ...
    {
      // Customer data
      this.Database.ExecuteSqlInterpolated($"{SakilaLiteData.CustomerData}");
    }
  }

...
namespace MySql.EntityFrameworkCore.Basic.Tests.DbContextClasses
{
  ...
  public class BodyShopContext : MyTestContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity<Car>().ToTable("Car", "01cars");
      modelBuilder.Entity<BodyShop>().ToTable("BodyShop", "02bodyshops");
      modelBuilder.Entity<Employee>().ToTable("Employee", "03employees");
    }
  }
  public class BodyShopInsertContext : MyTestContext
  {
    public DbSet<Car> Car { get; set; }
  ...
  public class ConnStringOnConfiguringContext : MyTestContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      modelBuilder.Entity<TestCharsetFA>(e =>
      {
        ...
        e.Property(p => p.TestCharsetFAId).ForMySQLHasCharset("latin7").HasMaxLength(255);
      });

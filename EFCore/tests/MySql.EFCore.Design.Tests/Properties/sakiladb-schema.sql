...
GROUP_CONCAT(DISTINCT CONCAT(c.name, ': ',
		(SELECT GROUP_CONCAT(f.title ORDER BY f.title SEPARATOR ', ')
                    FROM sakiladb.film f
                    INNER JOIN sakiladb.film_category fc
                      ON f.film_id = fc.film_id
                    INNER JOIN sakiladb.film_actor fa
...
AS film_info
FROM sakiladb.actor a
LEFT JOIN sakiladb.film_actor fa
  ON a.actor_id = fa.actor_id
LEFT JOIN sakiladb.film_category fc
  ON fa.film_id = fc.film_id
LEFT JOIN sakiladb.category c

...
{
  public class DeleteStatement : FilterableStatement<DeleteStatement, Table, UpdateResult>
  {
    public DeleteStatement(Table table, string condition) : base(table, condition)
    {

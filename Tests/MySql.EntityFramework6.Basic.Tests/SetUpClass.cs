...
namespace MySql.Data.Entity.Tests
{
  ...
  {   
    ...
    public MySqlConnection rootConn { get; set; }
    ...
    public string database0 { get; set; }
    public string database1 { get; set; }
    public Version version { get; set; }

    public string table;
    public string csAdditions = String.Empty;
    public bool accessToMySqlDb;
     ...
     public void MyInit()
    {
      ...
      Stream stream = executingAssembly.GetManifestResourceStream("MySql.Data.Entity.Tests.Properties.Setup.sql");
    ...
    public void SetAccountPerms(bool includeProc)
    {
    ...
    public event GetConnectionStringInfoCallback OnGetConnectionStringInfo;
     ...
     public string GetConnectionString(string userId, string pw, bool persistSecurityInfo, bool includedb)
    {
     ...
     public string GetConnectionString(string userId, string pw, bool includedb)
    {
      return GetConnectionString(userId, pw, true, includedb);
    }

     public string GetConnectionString(bool includedb)
    {
    ...
    public void suExecSQL(string sql)
    {
...
#if !RT
    public void CheckOrphanedConnections()
    {
    ...
    public void KillOrphanedConnections()
    {
     ...
     public string GetPoolingConnectionString()
    {
     ...
     public void KillConnection(MySqlConnection c)
    {
     ...
     public MySqlDataReader execReader(string sql)
    {
     ...
     public void createTable(string sql, string engine)
    {
     ...
     public void ExecuteSQLAsRoot(string sql)
    {
  ...
  {
    public SetUpClassPerTestInit st;

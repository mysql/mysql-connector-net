...
namespace MySql.Data.MySqlClient.Tests
{
  public class MySqlDataReaderTests : IUseFixture<SetUpClass>, IDisposable
  {
    ...
    public void GetStringOnNull()
    {
      ...
      {
        reader.Read();
        Exception ex = Assert.Throws<System.Data.SqlTypes.SqlNullValueException>(() => reader.GetString(reader.GetOrdinal("Sub_part")));
        Assert.Equal(ex.Message, "Data is Null. This method or property cannot be called on Null values.");
      }
    }
    ...
    private void FillErrorEventHandler(object sender, FillErrorEventArgs e)
    {
      e.Continue = true;
    }
  }

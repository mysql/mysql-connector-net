...
namespace MySql.Data.MySqlClient.Tests
{
  public class SetUpClass : IDisposable
  {
    ...
    internal protected void SetAccountPerms(bool includeProc)
    {
    ...
    internal void suExecSQL(string sql)
    {
    ...
    internal void execSQL(string sql)
    {
    ...
    internal void createTable(string sql, string engine)
    {

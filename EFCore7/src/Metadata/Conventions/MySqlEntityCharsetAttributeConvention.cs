...
{
  /// <summary>
  ///   Represents a <see cref="MySQLCharsetAttribute"/> for an entity.
  /// </summary>
  internal class MySqlEntityCharsetAttributeConvention : EntityTypeAttributeConventionBase<MySQLCharsetAttribute>
  {
    /// <summary>

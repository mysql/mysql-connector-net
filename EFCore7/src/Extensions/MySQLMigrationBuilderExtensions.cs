...
namespace MySql.EntityFrameworkCore.Extensions
{
  ...
  {
    /// <summary>
    ///   Indicates whether the database provider currently in use is the MySQL Server provider.
    /// </summary>
    ...
    /// <returns><see langword="true"/> if MySQL Server is being used; otherwise, <see langword="false"/>.</returns>

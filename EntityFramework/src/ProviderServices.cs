  ...
  public class MySqlScriptServices
	...
	public sealed class MySqlProviderServices : DbProviderServices
	{
		...
		private void SetFunctionExpectedTypes(DbFunctionCommandTree tree, EFMySqlCommand cmd)
		{
            ...
            EntityFramework.Properties.Resources.WrongFunctionResultType);
				...
				{
					Debug.Fail(EntityFramework.Properties.Resources.WrongFunctionResultType);
				}
			}
		}
		...
		protected override void DbCreateDatabase(DbConnection connection, int? commandTimeout, StoreItemCollection storeItemCollection)
		{
			...
			if (conn == null)
				throw new ArgumentException(EntityFramework.Properties.Resources.ConnectionMustBeOfTypeMySqlConnection, "connection");

...
namespace MySql.Data.MySqlClient.Interceptors
{
  ...
  internal sealed partial class CommandInterceptor : Interceptor
  {
    ...
    partial void ResolveTypeConfiguration();
    ...
    protected override string ResolveType(string nameOrType)
    {
...
#else
      ResolveTypeConfiguration();
      //TODO: MOVE CODE TO ResolveTypeConfiguration IN 452 AND 46 PROJECTS
      ...
      //    return e.Type;
      //return base.ResolveType(nameOrType);
      return base.ResolveType(nameOrType); //Remove when is integrated, is for avoid error
#endif
    }
  }
}

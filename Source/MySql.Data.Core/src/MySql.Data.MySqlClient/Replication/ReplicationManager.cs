...
namespace MySql.Data.MySqlClient.Replication
{
  ...
  /// </summary>
  internal static partial class ReplicationManager
  {
    ...
    //private static Dictionary<string, ReplicationServerSelector> selectors = new Dictionary<string, ReplicationServerSelector>();
     ...
     static partial void Constructor();
    ...
    //    groupType = "MySql.Data.MySqlClient.Core.Replication.ReplicationRoundRobinServerGroup";
    ...
    //{
    //  ReplicationServerGroup group = _groups.FirstOrDefault(g => String.Compare(g.Name, groupName, StringComparison.OrdinalIgnoreCase) == 0);
    //  if (group == null)
    ...
    //{
    //  return _groups.Any(g => String.Compare(g.Name, groupName, StringComparison.OrdinalIgnoreCase) == 0);
    //}
